...
open class AddressListAdapter(
    ...
    private class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val tv_address_full_name = view.findViewById<TextView>(R.id.tv_address_full_name)
        val tv_address_type = view.findViewById<TextView>(R.id.tv_address_type)
        val tv_address_details = view.findViewById<TextView>(R.id.tv_address_details)
        val tv_address_mobile_number = view.findViewById<TextView>(R.id.tv_address_mobile_number)
    }
}